  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {/* View Switcher Tabs */}
        <div className="flex p-1 bg-[var(--glass)] rounded-2xl md:w-64">
          <button
      ...
      <AnimatePresence mode="wait">
        {activeView === 'azkar' ? (
          ...
          >
            {/* Azkar Category Tabs */}
            <section className="flex gap-2 p-1 bg-[var(--glass)] rounded-2xl overflow-x-auto no-scrollbar">
            ...
            <section className="space-y-4">
              <div className="flex justify-between items-center px-1">
                ...
                <button 
                  ...
                  className="p-2 rounded-xl bg-[var(--color-primary)]/10 text-[var(--color-primary)] flex items-center gap-1.5 hover:bg-[var(--color-primary)] hover:text-[var(--color-text-primary)] transition-all transform active:scale-95"
                >
                  <Plus size={14} />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  {filteredAthkar.map(item => {
                    ...
                    return (
                      <motion.div
                        ...
                        className={`glass-card p-5 space-y-4 border-[var(--glass-border)] group transition-all duration-300 ${!available ? 'opacity-40 grayscale pointer-events-none' : 'hover:border-[var(--color-primary)]/30 shadow-xl'}`}
                      >
                        ...
                        {!available ? (
                          ...
                          <div className="flex gap-2 pt-2">
                            ...
                            <button
                              ...
                              className="px-4 py-3 rounded-xl bg-emerald-500/10 text-emerald-500 hover:bg-emerald-500 hover:text-[var(--color-text-primary)] transition-all text-[10px] font-bold border border-emerald-500/10"
                            >
                              تم
                            </button>
                          </div>
                ...
                {filteredAthkar.length === 0 && (
                  <div className="col-span-full py-16 text-center border-2 border-dashed border-[var(--glass-border)] rounded-[32px]">
            ...
            <section className="glass-card p-6 md:p-10 flex flex-col items-center gap-8 relative overflow-hidden bg-purple-500/5 border-purple-500/10">
              <div className="absolute top-0 left-0 w-full h-1 bg-[var(--glass)]">
                <motion.div 
                  className="h-full bg-purple-500 shadow-[0_0_10px_rgba(168,85,247,0.5)]"
                  animate={{ width: `${activeSession ? (activeSession.progress / activeSession.target) * 100 : 0}%` }}
                />
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <div className="flex items-center gap-12 pt-4">
                  ...
                  <div className="w-px h-16 bg-[var(--glass-hover)]" />
                  <div className="text-center space-y-1">
              ...
              <motion.button
                ...
                className={`w-32 h-32 md:w-40 md:h-40 rounded-full flex flex-col items-center justify-center gap-3 transition-all duration-500 shadow-2xl relative group ${
                  isPartnerOnline 
                    ...
                    : 'bg-[var(--glass)] text-[var(--text-mute)] border-2 border-[var(--glass-border)]'
                }`}
              >
          ...
          >
            <section className="glass-card p-6 md:p-8 space-y-8 border-emerald-500/20 bg-emerald-500/5 relative overflow-hidden">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
                 <div className="space-y-4 p-5 rounded-3xl bg-[var(--glass)] border border-[var(--glass-border)] backdrop-blur-sm">
                   ...
                   <div className="h-2 w-full bg-[var(--glass-active)] rounded-full overflow-hidden border border-[var(--glass-border)]">
                     <motion.div 
                       initial={{ width: 0 }}
               ...
               <div className="flex flex-col sm:flex-row gap-3 pt-4 relative z-10">
                 <div className="relative flex-1">
                   <input 
                     ...
                     className="w-full bg-[var(--glass)] border border-[var(--glass-border)] rounded-2xl px-6 py-4 text-sm font-bold outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all text-center"
                     id="quranVersesInput"
                   />
                 </div>
                 <button 
        ...
        {showAddModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/60 backdrop-blur-md">
            ...
            <motion.div 
              ...
              className="bg-[var(--color-bg-card)] w-full max-w-sm rounded-[40px] p-8 border border-[var(--glass-border)] shadow-2xl relative z-10"
            >
              ...
              <form onSubmit={handleCreate} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <select 
                      ...
                      className="w-full h-12 bg-[var(--glass)] border border-[var(--glass-border)] rounded-2xl px-4 text-xs font-bold font-sans outline-none appearance-none"
                    >
                ...
                <div className="pt-2">
                  <h4 className="text-[9px] font-black uppercase opacity-30 tracking-widest mb-4 px-2">التذكير والوقت (اختياري)</h4>
                  
                  {newAthkar.category !== 'custom' ? (
                     <div className="space-y-1.5">
                       <label className="text-[8px] font-black uppercase opacity-40 px-1">وقت التذكير</label>
                       <input 
                         type="time" 
                         value={newAthkar.reminderTime}
                         onChange={e => setNewAthkar(prev => ({ ...prev, reminderTime: e.target.value }))}
                         className="w-full h-11 bg-[var(--glass)] border border-[var(--glass-border)] rounded-xl px-4 text-[10px] font-bold outline-none"
                       />
                     </div>
                  ) : (
