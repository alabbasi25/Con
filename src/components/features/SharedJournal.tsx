          ...
          >
            <div className="flex justify-between items-center">
              ...
              <button 
                ...
                className="w-10 h-10 rounded-full hover:bg-[var(--glass-hover)] flex items-center justify-center transition-all"
              >
                <X size={20} />
              </button>
            </div>
            ...
            <div className="flex items-center justify-between pt-6 border-t border-[var(--glass-border)]">
              <div className="flex gap-2">
                <button 
                  ...
                  className="px-4 py-2 rounded-xl bg-[var(--glass)] border border-[var(--glass-border)] text-[10px] font-black uppercase flex items-center gap-2 hover:bg-[var(--glass-hover)] transition-all opacity-60"
                >
              ...
              <div className="flex gap-4 overflow-x-auto pb-2 no-scrollbar">
                {images.map((img, i) => (
                  <div key={i} className="relative group flex-shrink-0">
                    <img src={img} alt="attached" className="w-24 h-24 rounded-2xl object-cover border border-[var(--glass-border)]" referrerPolicy="no-referrer" />
                    <button 
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-6">
              {filteredJournal.map(entry => (
                <div key={entry.id} className="glass-card p-0 overflow-hidden flex flex-col md:flex-row border-[var(--glass-border)] hover:border-[var(--glass-border-hover)] transition-all group">
                  ...
                  <div className="p-6 flex-1 space-y-4">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="w-8 h-8 rounded-xl bg-[var(--glass)] border border-[var(--glass-border)] flex items-center justify-center text-[10px] font-black opacity-40">
                        {entry.authorId}
                      </div>
                    </div>
