...
export const PlanetWeather: React.FC = () => {
  ...
  return (
    <motion.div 
      ...
      className="glass-card p-8 text-center relative overflow-hidden group min-h-[280px] flex flex-col justify-center items-center border-[var(--glass-border)]"
    >
      ...
      <div className="space-y-6 relative z-10">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[var(--glass)] border border-[var(--glass-border)] text-[10px] font-black uppercase tracking-widest">
        ...
        <div className="relative">
          ...
          <motion.div 
            ...
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 border border-dashed border-[var(--glass-border)] rounded-full"
          />
        ...
        <div className="pt-4">
          <div className="inline-block px-6 py-3 rounded-2xl bg-[var(--glass)] border border-[var(--glass-border)] backdrop-blur-md">
