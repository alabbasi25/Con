            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="glass-card p-5 space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2 max-h-40 overflow-y-auto pr-1">
                    {plan.packingList.map((item, i) => (
                      <motion.div 
                        ...
                        className={`flex items-center justify-between p-2 rounded-xl transition-all cursor-pointer ${item.packed ? 'bg-green-500/10 text-green-500' : 'bg-[var(--glass)] hover:bg-[var(--glass-hover)]'}`}
                      >
                  ...
                  <div className="pt-2 border-t border-[var(--glass-border)] flex gap-2">
                    <input 
                      type="text"
                      ...
                      className="flex-1 bg-[var(--glass)] border border-[var(--glass-border)] rounded-lg px-3 py-2 text-[10px] outline-none"
                    />
                    <motion.button 
                      whileHover={{ scale: 1.1 }}
                      whileTap={{ scale: 0.9 }}
