    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="glass-card h-64 relative overflow-hidden bg-slate-900/50 border-rose-500/20">
          ...
          <div className="absolute bottom-4 left-4 right-4 p-3 glass-card bg-[var(--glass-active)] border-[var(--glass-border)] flex items-center gap-3">
          ...
          {!activePrompt.answers[currentUser] ? (
            <div className="space-y-4">
              <textarea 
                ...
                className="input-field min-h-[120px] text-center py-4 bg-[var(--glass)] border-rose-500/20 focus:border-rose-500"
              />
              <button 
