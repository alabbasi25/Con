      ...
      <div className="flex justify-between items-end">
        ...
        <div className="flex gap-2">
          <button 
            ...
            className="px-4 py-2 rounded-xl bg-[var(--glass)] border border-[var(--glass-border)] text-[10px] font-black hover:bg-[var(--glass-hover)] transition-all"
          >
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {moodsWithConfig.map(m => (
                <div key={m.id} className="flex items-center justify-between p-3 rounded-xl bg-[var(--glass)] border border-[var(--glass-border)]">
        ...
        {viewMode === 'log' ? (
          ...
          >
            ...
            <div className="glass-card p-8 space-y-8 text-center relative overflow-hidden group">
              <div className="absolute inset-0 bg-gradient-to-b from-[var(--glass)] to-transparent pointer-events-none" />
              ...
              <div className="grid grid-cols-4 md:grid-cols-7 gap-4 relative z-10">
                {moodsWithConfig.map((mood) => (
                  <motion.button
                    ...
                    className={`flex flex-col items-center gap-3 p-4 rounded-3xl transition-all duration-300 group/item ${selectedMood === mood.id ? `${mood.color} text-white shadow-xl ${mood.color}/40 scale-110` : 'bg-[var(--glass)] hover:bg-[var(--glass-hover)] border border-[var(--glass-border)]'}`}
                  >
              ...
              <div className="space-y-4 relative z-10">
                <input 
                  ...
                  className="w-full bg-[var(--glass)] border border-[var(--glass-border)] rounded-2xl px-6 py-4 text-sm outline-none focus:ring-1 focus:ring-[var(--color-primary)] placeholder:opacity-30"
                />
                <button 
                  onClick={handleLog}
              ...
              {moodLogs.map(entry => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-row md:flex-col items-center md:items-end justify-between md:justify-center border-t md:border-t-0 border-[var(--glass-border)] pt-4 md:pt-0">
