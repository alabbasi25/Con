      ...
      <section className="space-y-4">
        ...
        <div className="flex gap-4 overflow-x-auto pb-4 no-scrollbar -mx-6 px-6">
          {family.milestones?.map(milestone => (
            ...
            >
              <div className="relative h-72 bg-[var(--glass-active)]">
                {milestone.imageUrl ? (
                ...
                <div className="absolute top-4 right-4 px-3 py-1 rounded-full bg-[var(--glass-active)] backdrop-blur-md text-[8px] font-black text-white uppercase tracking-widest">
