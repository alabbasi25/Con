              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
                {conflictRoom.map((msg, idx) => (
                  <motion.div 
                    ...
                    className={`p-4 rounded-2xl shadow-sm border border-[var(--glass-border)] ${msg.authorId === currentUser ? 'bg-blue-500/10 mr-10 rounded-tr-none' : 'bg-amber-500/10 ml-10 rounded-tl-none'}`}
                  >
