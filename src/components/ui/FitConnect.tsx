    ...
    <div className="glass-card p-6 border-[var(--color-primary)]/20 relative overflow-hidden group">
      ...
      <div className="space-y-4 relative z-10">
        ...
        <motion.button 
          ...
          className={`w-full py-3 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2 ${isConnecting ? 'bg-[var(--glass)] opacity-50' : 'bg-[var(--color-primary)] text-white shadow-lg shadow-[var(--color-primary)]/20 hover:scale-[1.02]'}`}
        >
          {isConnecting ? (
            <motion.div 
              animate={{ rotate: 360 }}
