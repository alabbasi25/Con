    ...
    >
      ...
      <div className="glass-card p-8 flex flex-col items-center gap-8">
        ...
        <motion.button
          ...
          className="w-32 h-32 rounded-full bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-accent)] shadow-2xl shadow-[var(--color-shadow)] flex flex-col items-center justify-center text-white gap-2 border-4 border-[var(--glass-border)]"
        >
          <Fingerprint size={40} />
